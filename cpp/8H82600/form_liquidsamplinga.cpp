...
FormLiquidSamplingA::FormLiquidSamplingA(QWidget *parent, bool admin) :
    FormCommon(parent, "liquidsamplinga", QString::fromUtf8("采液1-8"), admin),
...
void FormLiquidSamplingA::InitUiState()
{
    if (admin_privilege_)
    {
        ...
        ui->label_TICA7211->installEventFilter(this);
        ui->label_TICA7218->installEventFilter(this);
