    ...
    ui(new Ui::FormTrend)
{
    ...
    line_defs.clear();
    line_defs.push_back(ChartLineDef("plc.1.pg_6", "PIA1113", "固定床前压力"));
    line_defs.push_back(ChartLineDef("plc.1.pg_7", "PIA1513", "釜前压力"));
    line_defs.push_back(ChartLineDef("plc.1.pg_8", "PIA2402", "固定床后压力"));
    line_defs.push_back(ChartLineDef("plc.1.pg_9", "PIA2802", "釜后压力"));
