...
namespace goiot {
    ...
    const Json::StaticString S7Driver::J_KEY_ID{ "id" };
    const Json::StaticString S7Driver::J_KEY_NAME{ "name" };
    const Json::StaticString S7Driver::J_KEY_PORT{ "port" };

    const Json::StaticString S7Driver::J_KEY_RESPONSE_TIMEOUT{ "response_timeout_msec" };
    const Json::StaticString S7Driver::J_KEY_REFRESH_INTERVAL{ "refresh_interval_msec" };
    const Json::StaticString S7Driver::J_KEY_NODES{ "nodes" };
    const Json::StaticString S7Driver::J_KEY_DATA{ "data" };
    const Json::StaticString S7Driver::J_KEY_ADDRESS{ "address" };
    const Json::StaticString S7Driver::J_KEY_RATIO{ "ratio" };
    const Json::StaticString S7Driver::J_KEY_OFFSET{ "offset" };
    const Json::StaticString S7Driver::J_KEY_REGISTER{ "register" };
    const Json::StaticString S7Driver::J_KEY_FDEC{ "fdec" };
